...
public class TheGame extends GameThread{
    ...
    //The point is the top left corner, not middle, of the ball
    //Initially at -100 to avoid them being drawn in 0,0 of the screen
    private float mSadBallX = -200;
    private float mSadBallY = -200;
    ...
    public void setupBeginning() {
        ...
        //Place SadBall in the middle of the screen
        mSadBallX = mCanvasWidth / 2;
        mSadBallY = mCanvasHeight / 2;
    ...
    protected void doDraw(Canvas canvas) {
        ...
        //Draw SadBall
        canvas.drawBitmap(mSadBall, mSmileyBallX - mSadBall.getWidth() / 2, mSadBallY - mSadBall.getHeight() / 2, null);
    }
    ...
    protected void updateGame(float secondsElapsed) {
        ...
        //Collision for sad ball
        distanceBetweenBallAndPaddle = (mSadBallX - mBallX) * (mSadBallX - mBallX) + (mSadBallY - mBallY) *(mSadBallY - mBallY);
